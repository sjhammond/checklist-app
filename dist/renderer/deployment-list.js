...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/renderer/deployment-list.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/renderer/deployment-list.ts":
/*!*****************************************!*\
  !*** ./src/renderer/deployment-list.ts ***!
  \*****************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ \"@babel/runtime/regenerator\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _data_db__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./data/db */ \"./src/renderer/data/db.ts\");\n/* harmony import */ var _models_product_tier__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/product-tier */ \"./src/renderer/models/product-tier.ts\");\n\n\nvar _this = undefined;\n\nvar __awaiter = undefined && undefined.__awaiter || function (thisArg, _arguments, P, generator) {\n  return new (P || (P = Promise))(function (resolve, reject) {\n    function fulfilled(value) {\n      try {\n        step(generator.next(value));\n      } catch (e) {\n        reject(e);\n      }\n    }\n\n    function rejected(value) {\n      try {\n        step(generator[\"throw\"](value));\n      } catch (e) {\n        reject(e);\n      }\n    }\n\n    function step(result) {\n      result.done ? resolve(result.value) : new P(function (resolve) {\n        resolve(result.value);\n      }).then(fulfilled, rejected);\n    }\n\n    step((generator = generator.apply(thisArg, _arguments || [])).next());\n  });\n};\n\n\n\nvar deploymentList = '';\nObject(_data_db__WEBPACK_IMPORTED_MODULE_1__[\"dbPromise\"])().then(function (appDB) {\n  return __awaiter(_this, void 0, void 0,\n  /*#__PURE__*/\n  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {\n    var tx, store;\n    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            // get the db then create a transaction, open obj store, and open cursor\n            tx = appDB.transaction(['deployments'], 'readonly');\n            store = tx.objectStore('deployments');\n            _context.next = 4;\n            return store.openCursor(undefined, 'prev');\n\n          case 4:\n            return _context.abrupt(\"return\", _context.sent);\n\n          case 5:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n}).then(function (cursor) {\n  return __awaiter(_this, void 0, void 0,\n  /*#__PURE__*/\n  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {\n    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {\n      while (1) {\n        switch (_context2.prev = _context2.next) {\n          case 0:\n            if (!cursor) {\n              _context2.next = 7;\n              break;\n            }\n\n            buildDeployments(cursor);\n            _context2.next = 4;\n            return cursor[\"continue\"]();\n\n          case 4:\n            cursor = _context2.sent;\n            _context2.next = 0;\n            break;\n\n          case 7:\n          case \"end\":\n            return _context2.stop();\n        }\n      }\n    }, _callee2);\n  }));\n}).then(function () {\n  if (deploymentList !== '') {\n    var noDeployments = document.getElementById('no-deployments');\n    if (noDeployments != null) noDeployments.style.display = 'none'; //hide 'no deployments found' message\n\n    var body = document.getElementById('deployment-list__body');\n    if (body != null) body.innerHTML = deploymentList;\n  }\n});\n\nvar buildDeployments = function buildDeployments(cursor) {\n  if (!cursor) {\n    return;\n  }\n\n  deploymentList += \"\\n          <tr>\\n              <td>\\n                  \".concat(cursor.value.name, \"\\n              </td>\\n              <td>\\n                  \").concat(_models_product_tier__WEBPACK_IMPORTED_MODULE_2__[\"ProductTier\"][cursor.value.productTier], \"\\n              </td>\\n              <td>\\n                  \").concat(cursor.value.dateCreated, \"\\n              </td>\\n              <td>\\n                  \").concat(cursor.value.dateModified.toLocaleString(), \"\\n              </td>\\n          </tr>\\n      \");\n};\n\n//# sourceURL=webpack:///./src/renderer/deployment-list.ts?");
